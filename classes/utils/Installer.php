...
class Installer
{
	...
	static public function install()
	{
		...
		Response::auto(CommandIO::exec("apt-get purge apache2 -y ; apt-get install sqlite3 nginx php{$phpv}-fpm php{$phpv}-sqlite3 php{$phpv}-readline network-manager proxychains tor python3.9-dev python3-pip cython3 gcc iptables whois curl wget -y --no-install-recommends") . "\n");
